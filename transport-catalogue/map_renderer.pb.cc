...
PROTOBUF_CONSTEXPR RendererSettings::RendererSettings(
...
struct RendererSettingsDefaultTypeInternal {
  PROTOBUF_CONSTEXPR RendererSettingsDefaultTypeInternal()
      : _instance(::_pbi::ConstantInitialized{}) {}
  ~RendererSettingsDefaultTypeInternal() {}
  union {
    RendererSettings _instance;
  };
};
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 RendererSettingsDefaultTypeInternal _RendererSettings_default_instance_;
}  // namespace proto_serialization
...
const uint32_t TableStruct_map_5frenderer_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::proto_serialization::RendererSettings, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::proto_serialization::RendererSettings, _impl_.width_),
  PROTOBUF_FIELD_OFFSET(::proto_serialization::RendererSettings, _impl_.height_),
  PROTOBUF_FIELD_OFFSET(::proto_serialization::RendererSettings, _impl_.padding_),
  PROTOBUF_FIELD_OFFSET(::proto_serialization::RendererSettings, _impl_.line_width_),
  PROTOBUF_FIELD_OFFSET(::proto_serialization::RendererSettings, _impl_.stop_radius_),
  PROTOBUF_FIELD_OFFSET(::proto_serialization::RendererSettings, _impl_.bus_label_font_size_),
  PROTOBUF_FIELD_OFFSET(::proto_serialization::RendererSettings, _impl_.bus_label_offset_),
  PROTOBUF_FIELD_OFFSET(::proto_serialization::RendererSettings, _impl_.stop_label_font_size_),
  PROTOBUF_FIELD_OFFSET(::proto_serialization::RendererSettings, _impl_.stop_label_offset_),
  PROTOBUF_FIELD_OFFSET(::proto_serialization::RendererSettings, _impl_.underlayer_color_),
  PROTOBUF_FIELD_OFFSET(::proto_serialization::RendererSettings, _impl_.underlayer_width_),
  PROTOBUF_FIELD_OFFSET(::proto_serialization::RendererSettings, _impl_.color_palette_),
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::proto_serialization::RendererSettings)},
};

static const ::_pb::Message* const file_default_instances[] = {
  &::proto_serialization::_RendererSettings_default_instance_._instance,
};

const char descriptor_table_protodef_map_5frenderer_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\022map_renderer.proto\022\023proto_serializatio"
  "n\032\tsvg.proto\"\226\003\n\020RendererSettings\022\r\n\005wid"
  "th\030\001 \001(\001\022\016\n\006height\030\002 \001(\001\022\017\n\007padding\030\003 \001("
  "\001\022\022\n\nline_width\030\004 \001(\001\022\023\n\013stop_radius\030\005 \001"
  "(\001\022\033\n\023bus_label_font_size\030\006 \001(\r\0224\n\020bus_l"
  "abel_offset\030\007 \001(\0132\032.proto_serialization."
  "Point\022\034\n\024stop_label_font_size\030\010 \001(\r\0225\n\021s"
  "top_label_offset\030\t \001(\0132\032.proto_serializa"
  "tion.Point\0224\n\020underlayer_color\030\n \001(\0132\032.p"
  "roto_serialization.Color\022\030\n\020underlayer_w"
  "idth\030\013 \001(\001\0221\n\rcolor_palette\030\014 \003(\0132\032.prot"
  "o_serialization.Colorb\006proto3"
  ;
...
const ::_pbi::DescriptorTable descriptor_table_map_5frenderer_2eproto = {
    false, false, 469, descriptor_table_protodef_map_5frenderer_2eproto,
    "map_renderer.proto",
...
class RendererSettings::_Internal {
 public:
  static const ::proto_serialization::Point& bus_label_offset(const RendererSettings* msg);
  static const ::proto_serialization::Point& stop_label_offset(const RendererSettings* msg);
  static const ::proto_serialization::Color& underlayer_color(const RendererSettings* msg);
};

const ::proto_serialization::Point&
RendererSettings::_Internal::bus_label_offset(const RendererSettings* msg) {
  return *msg->_impl_.bus_label_offset_;
}
const ::proto_serialization::Point&
RendererSettings::_Internal::stop_label_offset(const RendererSettings* msg) {
  return *msg->_impl_.stop_label_offset_;
}
const ::proto_serialization::Color&
RendererSettings::_Internal::underlayer_color(const RendererSettings* msg) {
  return *msg->_impl_.underlayer_color_;
}
void RendererSettings::clear_bus_label_offset() {
...
void RendererSettings::clear_stop_label_offset() {
...
void RendererSettings::clear_underlayer_color() {
...
void RendererSettings::clear_color_palette() {
  _impl_.color_palette_.Clear();
}
RendererSettings::RendererSettings(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                         bool is_message_owned)
  : ::PROTOBUF_NAMESPACE_ID::Message(arena, is_message_owned) {
  SharedCtor(arena, is_message_owned);
  // @@protoc_insertion_point(arena_constructor:proto_serialization.RendererSettings)
}
RendererSettings::RendererSettings(const RendererSettings& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  RendererSettings* const _this = this; (void)_this;
  new (&_impl_) Impl_{
  ...
  if (from._internal_has_bus_label_offset()) {
    _this->_impl_.bus_label_offset_ = new ::proto_serialization::Point(*from._impl_.bus_label_offset_);
  }
  if (from._internal_has_stop_label_offset()) {
    _this->_impl_.stop_label_offset_ = new ::proto_serialization::Point(*from._impl_.stop_label_offset_);
  }
  ...
  // @@protoc_insertion_point(copy_constructor:proto_serialization.RendererSettings)
}

inline void RendererSettings::SharedCtor(
...
RendererSettings::~RendererSettings() {
  // @@protoc_insertion_point(destructor:proto_serialization.RendererSettings)
...
inline void RendererSettings::SharedDtor() {
...
// @@protoc_insertion_point(message_clear_start:proto_serialization.RendererSettings)
...
const char* RendererSettings::_InternalParse(const char* ptr, ::_pbi::ParseContext* ctx) {
...
uint8_t* RendererSettings::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:proto_serialization.RendererSettings)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:proto_serialization.RendererSettings)
  return target;
}

size_t RendererSettings::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:proto_serialization.RendererSettings)
  size_t total_size = 0;
...
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData RendererSettings::_class_data_ = {
    ::PROTOBUF_NAMESPACE_ID::Message::CopyWithSourceCheck,
    RendererSettings::MergeImpl
};
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData*RendererSettings::GetClassData() const { return &_class_data_; }


void RendererSettings::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<RendererSettings*>(&to_msg);
  auto& from = static_cast<const RendererSettings&>(from_msg);
  // @@protoc_insertion_point(class_specific_merge_from_start:proto_serialization.RendererSettings)
  ...
  if (from._internal_has_bus_label_offset()) {
    _this->_internal_mutable_bus_label_offset()->::proto_serialization::Point::MergeFrom(
        from._internal_bus_label_offset());
  }
  if (from._internal_has_stop_label_offset()) {
    _this->_internal_mutable_stop_label_offset()->::proto_serialization::Point::MergeFrom(
...
// @@protoc_insertion_point(class_specific_copy_from_start:proto_serialization.RendererSettings)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
void RendererSettings::InternalSwap(RendererSettings* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(RendererSettings, _impl_.underlayer_width_)
      + sizeof(RendererSettings::_impl_.underlayer_width_)
      - PROTOBUF_FIELD_OFFSET(RendererSettings, _impl_.bus_label_offset_)>(
          reinterpret_cast<char*>(&_impl_.bus_label_offset_),
          reinterpret_cast<char*>(&other->_impl_.bus_label_offset_));
}

::PROTOBUF_NAMESPACE_ID::Metadata RendererSettings::GetMetadata() const {
...
template<> PROTOBUF_NOINLINE ::proto_serialization::RendererSettings*
Arena::CreateMaybeMessage< ::proto_serialization::RendererSettings >(Arena* arena) {
  return Arena::CreateMessageInternal< ::proto_serialization::RendererSettings >(arena);
}
